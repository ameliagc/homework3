...
answer_part_a = re.findall(regex_a, data)

# Updates file_paths_num with number of files in data
file_paths_num = len(answer_part_a)    
...
# Regular expression to find full paths
regex_b = r"\/Users|~"

# Stores returned value from findall in list variable
answer_part_b = re.findall(regex_b, data)

# Updates full_paths_num with number of full paths in data
full_paths_num = len(answer_part_b)
...
# Regular expression to find python files in SI 206 files
regex_c = r"SI206\/(\w).+.py"

# Stores returned value from findall in list variable
answer_part_c = re.findall(regex_c, data)

# Updates python_course_paths with number of python files in SI 206 folder
python_course_paths = len(answer_part_c)
